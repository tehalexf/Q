...
var pat = /^[\s\n]*([+-]([mtwrfsuMTWRFSU]+|(0[1-9]|1[0-2])\/(0[1-9]|[1-3][0-9])\/20(0[1-9]|1[0-9]))\s*([1-9]|1[0-2]):([30]0)\s*[apAP][mM]\s*-\s*([1-9]|1[0-2]):([30]0)\s*[apAP][mM]\s*((0[1-9]|[1-3][0-9])\/(0[1-9]|[1-3][0-9])\/(20[0-9][0-9])\s*(\-\s*(0[1-9]|[1-3][0-9])\/(0[1-9]|[1-3][0-9])\/(20[0-9][0-9]))?)?[\s\n]*)*$/
